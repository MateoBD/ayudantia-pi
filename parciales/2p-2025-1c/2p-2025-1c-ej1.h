...
/**
* Agrega -si no estaba- una nueva materia a la carrera. Si ya existe una materia con esa * descripción en la carrera, debe tener un código distinto
* El parámetro students indica cuántos alumnos están inscriptos en esa materia
* Retorna 1 si se agregó la materia, 0 si no (si la carrera era inválida o ya existía la * materia)
*/
...
/**
* Retorna la cantidad de alumnos que hay en una carrera. * Si la carrera es inválida retorna cero
*/
...
/**
* Si hay siguiente materia para una carrera, retorna 1 y deja en data la info sobre la * materia. Si no hay más materias para esa carrera retorna 0 y no cambia data
*/
