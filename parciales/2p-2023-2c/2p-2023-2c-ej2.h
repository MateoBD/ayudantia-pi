#ifndef _2P_2023_2C_EJ2_H
#define _2P_2023_2C_EJ2_H
...
typedef int (*compare_function_t)(landmarkType e1, landmarkType e2);
...
/**
 * Agrega un punto de interés libre a #meters metros del origen. Si ya había
